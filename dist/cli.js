  ...
  "node_modules/.pnpm/prompts@2.4.2/node_modules/prompts/dist/prompts.js"(exports2) {
    ...
    function toPrompt(type, args, opts = {}) {
      return new Promise((res, rej) => {
        ...
        const onSubmit2 = opts.onSubmit || noop;
        const onExit = opts.onExit || noop;
        p.on("state", args.onState || noop);
        p.on("submit", (x) => res(onSubmit2(x)));
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done; ) {
            ...
            try {
              ...
              quit = yield onSubmit2(question, answer, answers);
            } catch (err) {
...
var require_lib = __commonJS({
  "node_modules/.pnpm/prompts@2.4.2/node_modules/prompts/lib/index.js"(exports2, module2) {
    ...
    function prompt() {
      return __async(this, arguments, function* (questions = [], { onSubmit: onSubmit2 = noop, onCancel: onCancel2 = noop } = {}) {
        const answers = {};
        const override2 = prompt._override || {};
        questions = [].concat(questions);
        let answer, question, quit, name, type, lastPrompt;
        const getFormattedAnswer = (question2, answer2, skipValidation = false) => __async(this, null, function* () {
          if (!skipValidation && question2.validate && question2.validate(answer2) !== true) {
            return;
          }
          return question2.format ? yield question2.format(answer2, answers) : answer2;
...
var info = (text) => {
  console.log((0, import_picocolors.blue)(text));
};
var error = (text) => {
  console.log((0, import_picocolors.red)(text));
};
var succ = (text) => {
  console.log((0, import_picocolors.green)(text));
};

// src/create/index.ts
var onCancel = (prompt) => {
  error(`Command cancelled when setting ${prompt.name}`);
  process.exit(1);
};
var onSubmit = (prompt, answer, answers) => {
};
function createProject(_0, _1) {
  return __async(this, arguments, function* (projectName, { tailwind }) {
    const decisions = { projectName: "", useTailwind: false };
    if (!projectName) {
    ...
    if (!tailwind) {
      const { tailwind: tailwind2 } = yield (0, import_prompts.default)(
        {
          type: "toggle",
          name: "tailwind",
      ...
      decisions.useTailwind = tailwind2;
    }
    succ("read config successfully!");
...
cli.command("chaos [projectName]", "create project from template").option("-t, --tailwind", "use tailwindcss").action((projectName, options) => __async(exports, null, function* () {
  yield createProject(projectName, options);
}));
cli.help();
cli.parse();
